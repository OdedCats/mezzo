...
bool Network::read_passenger_rates_format1_TD_basic (istream& in) // reads the passenger rates in the format of arrival rate and alighting fraction per line and stop combination
{
  char bracket;
  int origin_stop_id, busline_id;
  double scale, slices;
