...
// STATISTICS
	...
	bool write_busstop_output(string name1, string name2, string name3, string name4, string name5, string name6, string name7, string name8, string name9); //<! writes all the bus-related output 
